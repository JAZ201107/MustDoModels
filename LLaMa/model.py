...
def precompute_theta_pos_frequencies(head_dim, seq_len, device, theta=10_000.0):
    ...
    # Construct the positional frequencies
...
class SelfAttention(nn.Module):
    ...
    def forward(self, x, start_pos, freqs_complex):
        ...
        scores = F.softmax(scores, dim=-1).type_as(x.dtype)
